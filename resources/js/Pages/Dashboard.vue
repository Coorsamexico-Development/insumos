    ...
    try {
        await axios
            ...
            .then((response) => {
                ...
                for (
                    let index = 0;
                    index < response.data.salidas.length;
                    index++
                ) {
                    ...
                    if (arraySalidasTemporal.length == 0) {
                        ...
                        newObjeto[`${salida.cliente}`] = parseInt(
                            salida.cantidad
                        );
                        ...
                        if (salida.new_date !== fechaTemporal) {
                            //si las fechas son diferentes entonces genera un nuevo objeto para el arreglo
                            let newObjeto = { fecha: salida.new_date };
                            newObjeto[`${salida.cliente}`] = parseInt(
                                salida.cantidad
                            );
                            ...
                            const ultimoElemento =
                                arraySalidasTemporal[
                                    arraySalidasTemporal.length - 1
                                ];
                            //console.log(ultimoElemento)
                            if (clienteTemporal == salida.cliente) {
                                //si el cliente y la fecha es igual se suma
                                //console.log( ultimoElemento[salida.cliente])
                                ultimoElemento[salida.cliente] += parseInt(
                                    salida.cantidad
                                );
                                clienteTemporal = salida.cliente;
                                fechaTemporal = salida.new_date;
                ...
                for (
                    let index = 0;
                    index < arraySalidasTemporal.length;
                    index++
                ) {
                    const element = arraySalidasTemporal[index];
                    for (
                        let index2 = 0;
                        index2 < response.data.salidasTotales.length;
                        index2++
                    ) {
...
<template>
    ...
    <div
        class="min-h-screen md:flex bg-[#F5F6FA]"
        style="font-family: 'Montserrat'"
    >
        <!--Contenedor-->
        <SideBar />
        <div class="w-full p-6">
            <!--Inicio del apartado de modulos-->
            <h1 class="text-2xl">
            ...
            <div class="grid w-full grid-cols-7">
                <div class="">
                    <h3
                        class="mt-2 text-2xl font-semibold tracking-wide uppercase"
                    >
                        Inventario
                    </h3>
                </div>
                <div class="flex flex-row col-start-3 col-end-5">
                    <!--Botones de importacion-->
                    <button
                        @click="openModalStages()"
                        class="flex flex-row items-center justify-between px-4 mx-1 border rounded-full shadow-lg"
                    >
                        <svg
                            class="mr-2"
                            ...
                            width="21.783"
                            height="18.63"
                            viewBox="0 0 21.783 18.63"
                        >
                            <defs>
                                <clipPath id="clip-path">
                                    <rect
                                        id="Rectángulo_2722"
                                        data-name="Rectángulo 2722"
                                        width="21.783"
                                        height="18.63"
                                        fill="#2684d0"
                                    />
                            ...
                            <g
                                id="Grupo_4442"
                                data-name="Grupo 4442"
                                transform="translate(7 5)"
                            >
                                <g
                                    id="Grupo_4441"
                                    data-name="Grupo 4441"
                                    transform="translate(-7 -5)"
                                ...
                                >
                                    <path
                                        ...
                                        d="M73.1,3.64v7.794a.333.333,0,0,0,.2.314l6.282,3.121v-8Zm7.048,11.229,6.292-3.121a.341.341,0,0,0,.186-.314V3.64L80.143,6.869v8ZM86.3,3.159,80.015.038a.353.353,0,0,0-.314,0L76.766,1.5l6.439,3.2ZM76.118,1.824l-2.7,1.335,6.439,3.21,2.7-1.345Z"
                                        transform="translate(-69.093 0.663)"
                                        fill="#2684d0"
                                        fill-rule="evenodd"
                                    />
                                    <path
                                        id="Trazado_4274"
                                        data-name="Trazado 4274"
                                        d="M11.582,253.74a.373.373,0,0,1-.175-.044L1.7,248.513a.373.373,0,0,1,.021-.668l1.933-.883a.373.373,0,1,1,.309.678l-1.248.57,8.873,4.737,9.365-4.757-2.126-.969a.373.373,0,0,1,.309-.678l2.83,1.29a.373.373,0,0,1,.014.671l-10.228,5.2A.372.372,0,0,1,11.582,253.74Z"
                                        transform="translate(-0.817 -235.793)"
                                        fill="#2684d0"
                                    />
                                </g>
                            </g>
                        </svg>
                        <p class="text-[#2684D0] hover:text-[#344182] text-sm">
                            Stage
                        </p>
                    </button>
                    <button
                    ...
                    >
                        <svg
                            ...
                            width="22"
                            height="13.933"
                            viewBox="0 0 22 13.933"
                        >
                            <g
                                id="camion-de-carga"
                                transform="translate(0 -112.204)"
                            >
                                <g
                                    id="Grupo_4443"
                                    data-name="Grupo 4443"
                                    transform="translate(0 112.204)"
                                >
                                    <path
                                        id="Trazado_4274"
                                        data-name="Trazado 4274"
                                        d="M454.75,395.756a1.87,1.87,0,1,0,1.87,1.87A1.872,1.872,0,0,0,454.75,395.756Zm0,2.42a.55.55,0,1,1,.55-.55A.551.551,0,0,1,454.75,398.176Z"
                                        transform="translate(-436.6 -385.563)"
                                        fill="#2684d0"
                                    />
                                    <path
                                        id="Trazado_4275"
                                        data-name="Trazado 4275"
                                        d="M401.471,179.518H398.24a.44.44,0,0,0-.44.44v8.58a.44.44,0,0,0,.44.44h.467a.439.439,0,0,0,.439-.373,2.535,2.535,0,0,1,5.009,0,.438.438,0,0,0,.439.373h.466a.44.44,0,0,0,.44-.44v-4.29a.439.439,0,0,0-.1-.282l-3.589-4.29A.44.44,0,0,0,401.471,179.518Zm-2.791,3.52v-2.2a.44.44,0,0,1,.44-.44h1.938a.44.44,0,0,1,.338.158l1.833,2.2a.44.44,0,0,1-.338.722H399.12A.44.44,0,0,1,398.68,183.038Z"
                                        transform="translate(-383.5 -177.098)"
                                        fill="#2684d0"
                                    />
                                    <path
                                        id="Trazado_4276"
                                        data-name="Trazado 4276"
                                        d="M.44,124.084H1.567a.439.439,0,0,0,.439-.373,2.426,2.426,0,0,1,2.5-2.144,2.426,2.426,0,0,1,2.5,2.144.438.438,0,0,0,.439.373H12.98a.44.44,0,0,0,.44-.44v-11a.44.44,0,0,0-.44-.44H.44a.44.44,0,0,0-.44.44v11A.44.44,0,0,0,.44,124.084Z"
                                        transform="translate(0 -112.204)"
                                        fill="#2684d0"
                                    />
                                    <path
                                        id="Trazado_4277"
                                        data-name="Trazado 4277"
                                        d="M75.31,395.756a1.87,1.87,0,1,0,1.87,1.87A1.872,1.872,0,0,0,75.31,395.756Zm0,2.42a.55.55,0,1,1,.55-.55A.551.551,0,0,1,75.31,398.176Z"
                                        transform="translate(-70.8 -385.563)"
                                        fill="#2684d0"
                                    />
                                </g>
                            </g>
                    ...
                    <a
                        :href="
                            route('movimientosExport', {
                                categoria: categoria_actual,
                            })
                        "
                        class="px-4 mx-1 border rounded-full shadow-lg text-[#2684D0] hover:text-[#344182] text-sm"
                    >
                        Descargar movimientos
                    </a>
                    <a
                        :href="
                            route('downloadCortes', {
                                categoria: categoria_actual,
                            })
                        "
                        class="px-4 mx-1 border rounded-full shadow-lg text-[#2684D0] hover:text-[#344182] text-sm"
            ...
            <div class="grid w-full grid-cols-5 my-4">
                <!--Modulos-->
                <!--Slider contenedor general-->
                <div class="col-start-1 col-end-4 px-8">
                    <!--Modulo general tabla-->
                    <div class="wrapper">
                        <!--Inicio de slide-->
                        <div class="container">
                            <input
                            ...
                            <label
                                for="c1"
                                class="card"
                                @click="params.inventario_actual = 1"
                            >
                                <div
                                    v-if="params.inventario_actual == 2"
                                    class="h-full bg-[#177DE9] text-white font-semibold"
                                    style="border-radius: 1rem 0% 0% 1rem"
                                >
                                    <div class="flex flex-row w-full rotate-90">
                                        <p class="ml-10 mr-2">Inventario</p>
                                        <p>Diario</p>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="description">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-2">
                                                    <a
                                                        ...
                                                        "
                                                        class="text-sm text-white bg-[#2684D0] px-2 py-1 rounded-full"
                                                    >
                                                        Descargar codigos
                                                    </a>
                                                </div>
                                            ...
                                            <div>
                                                <button
                                                    ...
                                                    :class="[
                                                        categoria_actual ==
                                                        categoria.id
                                                            ? 'px-4 mx-2 border rounded-xl bg-[#344182]'
                                                            : 'px-4 mx-2 border rounded-xl',
                                                    ]"
                                                ...
                                                <button
                                                    class="px-4 mx-2 border rounded-xl active:bg-[#344182]"
                                                >
                                                    <p
                                                        class="text-[#C3C4CE] text-center"
                                                    >
                                                        +
                                                    </p>
                                                </button>
                                        ...
                                        >
                                            <table class="w-full">
                                                    ...
                                                    >
                                                        ...
                                                        <button
                                                            @click="
                                                                openModalNewProduct()
                                                            "
                                                            class="bg-[#70BBF6] rounded-full flex flex-row justify-center items-center w-6"
                                                        >
                                                            <p
                                                ...
                                                <tbody>
                                                    <tr
                                                        v-for="producto in newProductos"
                                                        :key="producto.id"
                                                    >
                                                        <td
                                                            class="py-2 text-[#121A3C]"
                                                        >
                                                            <div
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <button
                                                                        class="bg-[#2684D0] mr-4 rounded-lg"
                                                                        @click="
                                                                            openModalGraph(
                                                                                producto
                                                                            )
                                                                    ...
                                                                    <img
                                                                        ...
                                                                        "
                                                                        class="w-4 h-4"
                                                                        src="../../assets/img/advertencia.svg"
                                                                    />
                                                                </div>
                                                                <button
                                                                    @click="
                                                                    ...
                                                                    "
                                                                    class="bg-[#C3C4CE] rounded-full pb-2 px-1"
                                                                >
                                                                    <img
                                                                        class="w-6 h-6"
                                                                        src="../../assets/img/….svg"
                                            ...
                                            -->
                                                        ...
                                                        >
                                                            <button
                                                                @click="
                                                                    openModalMovimientosByProducto(
                                                                        producto
                                                                    )
                                                                "
                                                                class="bg-[#2684D0] px-2 py-1 rounded-2xl"
                                                            >
                                                                <p
                            ...
                            <label
                                for="c2"
                                class="card"
                                @click="params.inventario_actual = 2"
                            >
                                <div
                                    v-if="params.inventario_actual == 1"
                                    class="h-full bg-[#70BBF6] text-white font-semibold"
        ...
        <!--Fin del apartado de modulos-->
        <!--Modales-->
        <ModalNewProduct
            :show="modalNewProduct"
            @close="closeModalNewProduct()"
            :categoria="categoria_actual"
        />
        <ModalStages
            :show="stageModal"
            :stages="stages"
            @close="closeModalStages()"
        />
        <ModalDts
            :show="modalDts"
            @close="closeModalDts()"
        ...
        />
        <ModalMovimientosByProducto
            :show="modalMovimientosByProducto"
            :movimientosByProducto="movimientosByProducto"
            :productoForMovimientos="productoForMovimientos"
            :ultimo_corte="ultimo_corte"
            @close="closeModalMvimientosByProducto()"
        />
        <ModalWatchProducInfo
            :show="watchInfoProd"
            :producto="producto_select"
            @close="closeWatchInfoProd()"
        />
        <ModalGraph
            :show="modalGraph"
            @close="closeModalGraph()"
            :salidasForModal="salidasForModal"
            :clientes="clientes"
            :elementsCateProducto="elementsCateProducto"
        />
        <!--Fin Modales-->
    </div>
    <!--Fin contenedor-->
