<template>
   <div  class="bg-[#3D4A8B] rounded-full flex justify-center items-center mx-1" style="height:60.542px ; width: 62.597px;"> 
      <svg  xmlns="http://www.w3.org/2000/svg" width="42.597" height="50.542" viewBox="0 0 52.597 50.542">
